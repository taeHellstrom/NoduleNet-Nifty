...
BASE = '/media/terese/New Volume1/Lung_cancer_project/Nifty_data_LIDC-IDRI/LIDC-Fidan-3/temp_cases_Fidanpreprocessed_test/' # make sure you have the ending '/'
data_config = {
    # put combined LUNA16 .mhd files into one folder
    'data_dir': BASE + 'CT_scans',                # Dir to CT images
    ...
    'lung_mask_dir': BASE + 'lung_segs',     # Dir to lung masks

    # Directory for saving intermediate results
    'ctr_arr_save_dir': BASE + 'mask_test',
    'mask_save_dir': BASE + 'nodule_segs',                     #Dir to nodule masks
...
train_config = {
    ...
    'test_set_name': '/media/terese/New Volume1/Lung_cancer_project/Nifty_data_LIDC-IDRI/LIDC-Fidan-3/temp_cases_Fidanpreprocessed_test/temp_cases.csv',           #'split/3_val.csv',
    'label_types': ['mask'],
    'DATA_DIR': data_config['preprocessed_data_dir'],
    'ROOT_DIR': '/media/terese/New Volume1/Lung_cancer_project/Nifty_data_LIDC-IDRI/LIDC-Fidan-3/temp_cases_Fidanpreprocessed_test' #'/home/terese/Documents/eMTIC/Lung_cancer_project/NoduleNet/NoduleNet-master' #os.getcwd()
}
